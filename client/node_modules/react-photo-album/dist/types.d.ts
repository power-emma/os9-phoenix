...
type ResponsiveParameter<Value = number> = Value | ((containerWidth: number) => Value);
/** Components props */
...
type ContainerComponentProps = React__default.ComponentPropsWithoutRef<"div">;
/** Track component props */
type TrackComponentProps = React__default.ComponentPropsWithoutRef<"div">;
/** Wrapper component props */
type WrapperComponentProps<TPhoto extends Photo = Photo> = ContextAware<React__default.ComponentPropsWithoutRef<"div">, RenderWrapperContext<TPhoto>>;
/** Link component props */
type LinkComponentProps<TPhoto extends Photo = Photo> = ContextAware<React__default.ComponentPropsWithoutRef<"a">, RenderLinkContext<TPhoto>>;
/** Button component props */
type ButtonComponentProps<TPhoto extends Photo = Photo> = ContextAware<React__default.ComponentPropsWithoutRef<"button">, RenderButtonContext<TPhoto>>;
/** Image component props */
type ImageComponentProps<TPhoto extends Photo = Photo> = ContextAware<React__default.ComponentPropsWithoutRef<"img">, RenderImageContext<TPhoto>>;
/** Click handler */
...
/** Render extras */
type RenderExtras<TPhoto extends Photo = Photo> = RenderFunction<{}, RenderPhotoContext<TPhoto>>;
/** Render function */
